...
public class Usuario
{
    ...
    public Propiedad addPropiedad(String nombre, String direccion, double precio, IPoliticaCancelacion politicaCancelacion)
    {
        Propiedad propiedad = new Propiedad(nombre, direccion, precio, this, politicaCancelacion);
